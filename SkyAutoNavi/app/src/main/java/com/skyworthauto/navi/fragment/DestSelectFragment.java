...
import com.skyworthauto.navi.ui.views.MapInteractiveView;
...
public class DestSelectFragment extends BaseSearchFragment implements View.OnClickListener {
    ...
    private void initViews(View v) {
        findViewById(v, R.id.auto_search_back_btn).setOnClickListener(this);
        findViewById(v, R.id.auto_search_back_btn).requestFocus();

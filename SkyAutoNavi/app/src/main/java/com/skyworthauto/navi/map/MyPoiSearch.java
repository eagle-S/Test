...
public class MyPoiSearch implements PoiSearch.OnPoiSearchListener {
    ...
    public void onPoiSearched(PoiResult result, int rCode) {
        ...
        Log.d(TAG, "getPageCount:" + result.getPageCount());
        Log.d(TAG, "getQuery:" + result.getQuery());
        Log.d(TAG, "getBound:" + result.getBound());
        Log.d(TAG, "getPois:" + Arrays.asList(result.getPois()));
        Log.d(TAG, "getSearchSuggestionKeywords:" + Arrays
                .asList(result.getSearchSuggestionKeywords()));
        Log.d(TAG, "getSearchSuggestionCitys:" + Arrays.asList(result.getSearchSuggestionCitys()));

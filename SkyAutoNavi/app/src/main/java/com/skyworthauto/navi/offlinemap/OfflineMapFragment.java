...
//						Toast.LENGTH_SHORT).show()
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.offline_map_layout, container, false);
		init(rootView);
		return rootView;
	}
	...
	private void init(View root) {
		...
		// 顶部
		mDownloadText = (TextView) findViewById(root, R.id.download_list_text);
		mDownloadedText = (TextView) findViewById(root, R.id.downloaded_list_text);

		mDownloadText.setOnClickListener(this);
		mDownloadedText.setOnClickListener(this);
		mBackImage = (ImageView) findViewById(root, R.id.auto_search_back_btn);
		mBackImage.requestFocus();
		mBackImage.setOnClickListener(this);

		// view pager 用到了所有城市list和已下载城市list所有放在最后初始化
		mContentViewPage = (ViewPager) findViewById(root, R.id.content_viewpage);

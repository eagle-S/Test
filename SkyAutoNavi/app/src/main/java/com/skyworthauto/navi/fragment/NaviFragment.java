...
public class NaviFragment extends BaseFragment implements AMapNaviListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.auto_navi_progress, container, false);
        initViews(root);
        return root;
    }
    ...
    private void initExitNaviPanel(View root) {
        mExitBtn = findViewById(root, R.id.ll_exit_setting);
        mExitBtn.setOnClickListener(this);
        mSettingBtn = findViewById(root, R.id.setting_btn_id);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ib_zoom_out:
                ...
                break;
            case R.id.ll_exit_setting:
                showExitConfirmDialog();
                break;
            case R.id.setting_btn_id:

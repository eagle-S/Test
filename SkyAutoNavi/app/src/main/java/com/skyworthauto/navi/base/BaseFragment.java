...
import com.skyworthauto.navi.focus.Focus;
import com.skyworthauto.navi.focus.FocusGroup;
import com.skyworthauto.navi.map.MapController;


public class BaseFragment extends Fragment implements IKeyEvent {
    ...
    public void replaceFragmentToActivity(BaseFragment fragment) {
    ...
    public void replaceFragmentToStack(Fragment newFragment) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        ft.replace(R.id.map_fragment_container, newFragment);
        ft.addToBackStack(null);
        ft.commit();
    }

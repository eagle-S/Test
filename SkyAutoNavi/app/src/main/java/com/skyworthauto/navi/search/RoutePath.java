...
import com.skyworthauto.navi.util.AMapUtils;
...
public class RoutePath {
    ...
    public RoutePath(int id, AMapNaviPath path) {
        mId = id;
        mAllLengthTip = AMapUtils.getFriendlyDistance(path.getAllLength());
        mAllTimeTip = AMapUtils.getFriendlyDistance(path.getAllTime());

...
public class SharePreferenceManager {
    ...
    public static void init() {
        sPreferences
                .put(PREFERENCE_SEARCH_HISTORY.hashCode(), new MySharedPreferences(
                        PREFERENCE_SEARCH_HISTORY));
        sPreferences
                .put(PREFERENCE_NAVI_CONFIG.hashCode(), new MySharedPreferences(
                        PREFERENCE_NAVI_CONFIG));
    }

...
import static com.skyworthauto.navi.util.ToastUtil.TAG;
...
import com.skyworthauto.navi.search.HomeSearchFragment;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ib_go_search:
                replaceFragmentToActivity(HomeSearchFragment.newInstance());
                break;
            default:
                break;
        }

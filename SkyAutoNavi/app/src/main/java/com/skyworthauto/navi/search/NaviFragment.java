...
public class NaviFragment extends BaseFragment implements AMapNaviListener {
    ...
    public static NaviFragment newInstance(int pathId) {
    ...
    public void showCross(AMapNaviCross aMapNaviCross) {
        Log.d(GlobalContext.TAG, "showCross bitmap=" + aMapNaviCross.getBitmap());
    ...
    public void showLaneInfo(AMapLaneInfo[] aMapLaneInfos, byte[] laneBackgroundInfo,
        ...
        Log.d(GlobalContext.TAG, "showLaneInfo!!!");
        for (int i = 0; i < aMapLaneInfos.length; i++) {
            Log.d(GlobalContext.TAG, "" + aMapLaneInfos[i].getLaneTypeIdHexString());
        }
        Log.d(GlobalContext.TAG, Arrays.toString(laneBackgroundInfo));
        Log.d(GlobalContext.TAG, Arrays.toString(laneRecommendedInfo));
